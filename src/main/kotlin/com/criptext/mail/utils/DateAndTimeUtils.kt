...
class DateAndTimeUtils {
    companion object {
        ...
        fun getUnsentDate(timestamp: Long, context: Context): String {
            ...
            val at = context.getLocalizedUIMessage(UIMessage(R.string.mail_template_at))
            val unsent = context.getLocalizedUIMessage(UIMessage(R.string.unsent))
