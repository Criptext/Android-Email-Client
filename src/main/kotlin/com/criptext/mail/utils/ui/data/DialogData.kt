...
sealed class DialogData(open val title: UIMessage, open val type: DialogType) {
    ...
    data class DialogCriptextProData(val image: Int, val message: UIMessage, override val type: DialogType): DialogData(UIMessage(R.string.you_need_pro_title), type)
}