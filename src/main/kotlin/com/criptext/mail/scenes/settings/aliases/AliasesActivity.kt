...
import com.criptext.mail.scenes.settings.aliases.data.AliasesDataSource
import com.criptext.mail.scenes.settings.custom_domain.data.CustomDomainDataSource
...
class AliasesActivity: BaseActivity(){

    override val layoutId = R.layout.activity_aliases
    ...
    override fun initController(receivedModel: Any, savedInstanceState: Bundle?): SceneController {
        val model = receivedModel as AliasesModel
        val view = findViewById<ViewGroup>(R.id.main_content)
        val scene = AliasesScene.Default(view)
        ...
        val dataSource = AliasesDataSource(
