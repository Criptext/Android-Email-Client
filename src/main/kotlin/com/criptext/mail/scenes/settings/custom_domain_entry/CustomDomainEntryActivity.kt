...
class CustomDomainEntryActivity: BaseActivity(){

    override val layoutId = R.layout.activity_custom_domain_entry
    ...
    override fun initController(receivedModel: Any, savedInstanceState: Bundle?): SceneController {
        val model = receivedModel as CustomDomainEntryModel
        val view = findViewById<ViewGroup>(R.id.main_content)
        val scene = CustomDomainEntryScene.Default(view)
        ...
        val dataSource = CustomDomainEntryDataSource(
        ...
        return CustomDomainEntryController(
                model = model,
                scene = scene,
