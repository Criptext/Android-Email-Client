...
class CustomDomainActivity: BaseActivity(){

    override val layoutId = R.layout.activity_custom_domain
    ...
    override fun initController(receivedModel: Any, savedInstanceState: Bundle?): SceneController {
        val model = receivedModel as CustomDomainModel
        val view = findViewById<ViewGroup>(R.id.main_content)
        val scene = CustomDomainScene.Default(view)
        ...
        val dataSource = CustomDomainDataSource(
