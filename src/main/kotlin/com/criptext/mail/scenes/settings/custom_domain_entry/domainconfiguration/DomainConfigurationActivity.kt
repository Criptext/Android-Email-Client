...
class DomainConfigurationActivity: BaseActivity(){

    override val layoutId = R.layout.activity_domain_configuration
    ...
    override fun initController(receivedModel: Any, savedInstanceState: Bundle?): SceneController {
        val model = receivedModel as DomainConfigurationModel
        val view = findViewById<ViewGroup>(R.id.main_content)
        val scene = DomainConfigurationScene.Default(view)
        ...
        val dataSource = DomainConfigurationDataSource(
        ...
        return DomainConfigurationController(
                model = model,
                scene = scene,
